...
export default function MyOrders() {
	...
	return (
		<>
			<HelmetAsync title={'Sifarişlərim'} />
								...
								{filteredOrders?.length > 1 ? (
									<tbody>
										{filteredOrders?.map((item) => (
											<tr key={item.id}>
												<td className={style.bodyPrId}>
													{item.id}
												</td>
												<td
													className={
														style.bodyPrNamePriceWrapper
													}
												>
												...
												<td className={style.bodyPrStatus}>
													<span
														className={style.bodyPrstatusBtn}
													>
														{item.status}
													</span>
												</td>
									...
									<tbody>
										<tr>
											<td className={style.searchResultNoProduct}>
												{currentPage}-ci səhifədə axtarışınıza
												uygun məhsul tapılmadı
											</td>
										</tr>
									</tbody>
								)}
