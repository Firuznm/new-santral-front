...
export default function HomeMainSlider({ dataMainSlider, dataDiscounted }) {
	...
	const mainSliderLeftData = mainSliderData.leftData;
	const mainSliderBottomRightDatas = mainSliderData.bottomRight;
	const mainSliderBottomRightLeft = mainSliderData.bottomLeft;
					...
					<div className={styles.mainSliderRightBottomWrapper}>
						<div className={styles.rightBottomLeft}>
							<MainSlider
								...
								data={mainSliderBottomRightLeft}
						...
						<div className={styles.rightBottomRight}>
							<MainSlider
								...
								data={mainSliderBottomRightDatas}
							...
							>
								...
								{item?.product && item?.product?.discountPercent > 0 && (
									<div className={styles.prInfo}>
										<span className={styles.prDiscountPercent}>
										...
										<div className={styles.prPriceWrapper}>
											...
											<span className={styles.oldPrice}>
												{item?.product?.oldPrice?.toFixed(1)}
											</span>
